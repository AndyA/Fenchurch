...
CREATE TABLE `test_edit` (
  ...
  `old_data` longtext NOT NULL COMMENT 'JSON representation of previous data',
  `new_data` longtext NOT NULL COMMENT 'JSON representation of change',
...
CREATE TABLE `test_programmes_v2` (
  ...
  `synopsis` longtext COMMENT 'Synopsis longtext',
  `footnote` longtext COMMENT 'Footnote text',
  `text` longtext COMMENT 'Full text',
...
CREATE TABLE `test_related` (
  ...
  `text` longtext COMMENT 'The textual content of the block, if any',
...
-- Dump completed on 2017-04-04 16:58:28
